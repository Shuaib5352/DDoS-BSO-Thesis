    ...
    },
    {
        ...
        sections: [
            ...
            },
            {
                ...
                paragraphs: [
                    `AH₁: KABUL EDİLDİ — BSO-Hybrid RF (F1-Macro: %${MODEL_RESULTS[0].f1Macro}), varsayılan RF (F1-Macro: %84,13) modeline göre istatistiksel olarak anlamlı düzeyde daha yüksek performans göstermiştir. Eşleştirilmiş t-testi: p < 0.001, Cohen's d = ${STATISTICAL_TESTS[0].cohenD.toFixed(2)} (büyük etki).\n\nAH₂: KABUL EDİLDİ — BSO, ${DATASET_STATISTICS.totalFeatures} özellikten ${BSO_SELECTED_FEATURES.length}'e düşürme sağlamıştır (%${DATASET_STATISTICS.featureReductionPct} azalma). Doğruluk kaybı: yalnızca +0,08% (89,74% → 89,82%). Bu, AH₂'nin şartı olan "%1'den az kayıp" kriterini karşılar.\n\nAH₃: KABUL EDİLDİ — BSO (fitness: 0.177801) < GA (0.188982) < GWO (0.192181) < PSO (0.193895). BSO en düşük uygunluk değerini elde etmiş ve en az özellikle (19) en iyi sonuca ulaşmıştır. Wilcoxon testi: BSO vs PSO-RF p = 0.001953 (anlamlı).`,
                ],
                tables: [],
                figures: [],
            },
